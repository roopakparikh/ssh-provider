...
*/
// Source: https://github.com/kubernetes/kubernetes/blob/v1.10.4/pkg/kubelet/apis/kubeletconfig/v1beta1/types.go
package v1alpha2
...
type KubeletAuthorization struct {
	...
	// +optional
	Webhook KubeletWebhookAuthorization `json:"webhook,omitempty"`
}
...
type KubeletAuthentication struct {
	...
	// +optional
	X509 KubeletX509Authentication `json:"x509,omitempty"`
	// webhook contains settings related to webhook bearer token authentication
	// +optional
	Webhook KubeletWebhookAuthentication `json:"webhook,omitempty"`
	// anonymous contains settings related to anonymous authentication
	// +optional
	Anonymous KubeletAnonymousAuthentication `json:"anonymous,omitempty"`
}
